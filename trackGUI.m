...
% Last Modified by GUIDE v2.5 07-Sep-2021 07:37:23
...
if handles.definirapc == 17  %criacao de grid de areas de interesse
   ...
   if  handles.definirapc == 18
        ...
        %criar as nlinhas x ncolunas areas (se ja existir uma �rea, antiga,
        %deixa ela l�. se depois o usuario quiser adicinar mais areas,
        %tambem pode)
        n = length(handles.areaint);
